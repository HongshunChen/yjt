		               ...
		               {x2;tree:$pages['data'],cal,cid}
						...
						<!-- 	<td>
							...
							<td>
								...
								<img class="img-polaroid" width="200" src="{x2;realhtml:v:cal[subtiltle]}">
							...
							<td>
								<div class="btn-group">
									<a class="btn" href="index.php?document-master-selfquestions-addselfquestions&catid={x2;v:cal[subid]}" title="批改"><em class="icon-edit icon-bl"></em></a>
