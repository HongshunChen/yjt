		...
		<div class="span10">
			...
			<fieldset>
					...
					<tr>
						...
						<td>
							<a class="btn ajax" href="index.php?vedio-master-recyle-regainseeding&catid={x2;v:val['vid']}" title="恢复"><em class="icon-edit"></em></a>
								<a class="btn ajax" href="index.php?vedio-master-recyle-deletseeding&catid={x2;v:val['vid']}" title="删除"><em class="icon-remove"></em></a>
						</td>
					</tr>
					{x2;endtree}
