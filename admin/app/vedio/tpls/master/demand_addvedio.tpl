...
{x2;endif}
			<ul class="breadcrumb">
				<li><a href="index.php?{x2;$_app}-master">全局</a> <span class="divider">/</span></li>
				...
				<li class="pull-right">
					<a href="index.php?vedio-master-demand-vedio&catid={x2;$courceid}">视频管理</a>
				</li>
			</ul>
    ...
    var upload = new PolyvUpload(obj);
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						{x2;tree:$cat,val,cid}
						{x2;if:v:val['courseid'] == $courseid}
		        		<option value="{x2;v:val['courseid']}" selected="selected">{x2;v:val['coursename']}</option>
				  		{x2;else}
