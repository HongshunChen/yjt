...
{x2;endif}
			<ul class="breadcrumb">
				...
				<li><a href="index.php?{x2;$_app}-master-assem">组卷管理</a> <span class="divider">/</span></li>
			...
			<ul class="nav nav-tabs">
				...
				<li class="pull-right">
					<a href="index.php?{x2;$_app}-master-assem">组卷管理</a>
				</li>
			</ul>
	        <form action="index.php?exam-master-exams-addassembly" method="post" class="form-horizontal">
				...
				<div class="modeplane">
				{x2;tree:$questypes,questype,qid}
				<div class="control-group questpanel panel_{x2;v:questype['questid']}" style="display:block">
