...
{x2;endif}
			<ul class="breadcrumb">
				...
				<li><a href="index.php?{x2;$_app}-master-questions&page={x2;$page}{x2;$u}">试题管理</a> <span class="divider">/</span></li>
			...
			<ul class="nav nav-tabs">
				...
				<li class="pull-right">
					<a href="index.php?{x2;$_app}-master-questions&page={x2;$page}{x2;$u}">试题管理</a>
				</li>
			</ul>
			<form action="index.php?exam-master-questions-addquestion" method="post" class="form-horizontal">
				...
				<div class="control-group">
				<label class="control-label" for="qrarea">考题所属区域：</label>
			  		<div class="controls">
			  			<select id="qrarea" needle='needle' msg="您必须为要添加的试题选择一个地区" name="args[questionsarea]" class="combox" onchange="javascript:setAnswerHtml($(this).find('option:selected').attr('rel'),'answerbox');">
			  			{x2;tree:$questionarea,quesarea,qid}
			<option rel="{x2;v:quesarea['areaid']}" value="{x2;v:quesarea['areaid']}"{x2;if:v:quesarea['areaid'] == $question['questionsarea']} selected{x2;endif}>{x2;v:quesarea['area']}</option>
						{x2;endtree}
			  			</select>
					</div>
				</div>
					...
					<div class="controls">
						<div id="answerbox_1" class="answerbox">
						  	<label class="radio inline">
						  		<input type="radio" name="targs[questionanswer1]" value="A">A
						  	</label>
						  	<label class="radio inline">
						...
						<div id="answerbox_4" class="answerbox" style="display:none;">
						  	<label class="radio inline">
						  		<input type="radio" name="targs[questionanswer4]" value="A">对
						  	</label>
						  	<label class="radio inline">
