	        ...
	        <table class="table table-hover">
	            ...
	            <tbody>
			        ...
			        <tr>
						...
						<td>
							<div class="btn-group">
	                    		<a class="btn ajax" href="index.php?exam-master-questions-backquestion&page={x2;$page}&questionid={x2;v:question['questionid']}{x2;$u}" title="恢复本题"><em class="icon-edit"></em></a>
