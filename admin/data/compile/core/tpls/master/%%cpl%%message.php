        ...
        <table class="table table-hover table-bordered"> 
          <thead>
            ...
            <tbody><tr>
              <td width="16%">账号</td>
              <td id="cfgapp">
                <?php echo $this->tpl_var['config']['cfgapp']; ?> </td>
            </tr>
              <tr>
              <td>密钥</td>
              <td><?php echo $this->tpl_var['config']['cfgsetting']; ?></td>
            </tr>
   ...
   <table class="table table-hover table-bordered"> 
          <thead>
            ...
            <tr>
              <td width="16%">模板名称</td>
              <td>
                <?php echo $this->tpl_var['mobile']['smsname']; ?></td>
            </tr>
              <tr>
              <td>模板内容</td>
              <td><?php echo $this->tpl_var['mobile']['smstemplate']; ?></td>
            </tr>
             <tr>
              <td>用户签名</td>
              <td><?php echo $this->tpl_var['mobile']['smsautograph']; ?></td>
            </tr>
                      </tbody></table>
  ...
  <div class="modal-body">
      ...
      <table class="table table-hover table-bordered"> 
            <tbody><tr>
              <td width="16%">账号</td>
              <td>
               <input name="args[smsname]" id="smsname" type="text" value="<?php echo $this->tpl_var['config']['cfgapp']; ?>"  alt="请输入账号" /></td>
            </tr>
              <tr>
              <td>密钥</td>
              <td><input name="args[smspwd]" id="smspwd" type="text" value="<?php echo $this->tpl_var['config']['cfgsetting']; ?>"  alt="请输入密钥"  /></td>
            </tr>
