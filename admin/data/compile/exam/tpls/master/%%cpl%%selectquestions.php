					...
					<table class="table">
						...
						<tr>
							<td class="form-inline">
								...
								<option value="1"<?php if($this->tpl_var['search']['questionisrows']){ ?> selected<?php } ?>>阅读题</option>
						  		</select>
 ...
 $kid++; ?>
				...
				<table class="table table-hover">
					<thead>
						<tr>
					        <th><input type="checkbox" onclick="javascript:selectall(this,'iselectquestions_<?php echo $this->tpl_var['search']['questiontype']; ?>','ialreadyselectnumber_<?php echo $this->tpl_var['search']['questiontype']; ?>');"/></th>
					        <th>试题内容</th>
					        <th>小题量</th>
					        <th>难度</th>
						</tr>
