...
<?php } ?>
 ...
 $qid++; ?>
			        <tr>
						...
						<td>
							<div class="btn-group">
	                    		<a class="btn ajax" href="index.php?exam-master-questions-backquestion&page=<?php echo $this->tpl_var['page']; ?>&questionid=<?php echo $question['questionid']; ?><?php echo $this->tpl_var['u']; ?>" title="恢复本题"><em class="icon-edit"></em></a>
