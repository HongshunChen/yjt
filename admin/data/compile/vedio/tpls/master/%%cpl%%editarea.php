...
<?php } ?>
			<ul class="breadcrumb">
				...
				<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-basic-questype">分类管理</a> <span class="divider">/</span></li>
	        ...
	        <form action="index.php?vedio-master-demand-editarea" method="post" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<select class="combox" id="questsort" name="args[catparent]" onchange="javascript:if($(this).val() == '1')$('#choicebox').hide();else $('#choicebox').show();">
							<option value="课程内容">课程内容</option>
