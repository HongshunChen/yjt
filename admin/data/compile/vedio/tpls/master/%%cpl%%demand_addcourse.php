...
<?php } ?>
 ...
 $sid++; ?>
					...
					<div class="controls">
						<input class=" datetimepicker" data-date="<?php echo date('Y-m-d',TIME); ?>" data-date-format="yyyy-mm-dd" type="text" name="args[courseendtime]" size="10" id="stime" value=""/>
					</div>
				</div>
				<div class="control-group">
 ...
 $sid++; ?>
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea class="input-xlarge" rows="4" name="args[courseatract]" id="courseatract"><?php echo $this->tpl_var['basic']['basicprice']; ?></textarea>
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea class="ckeditor" rows="4" name="args[courseintro]" id="basicprice"><?php echo $this->tpl_var['basic']['basicprice']; ?></textarea>
