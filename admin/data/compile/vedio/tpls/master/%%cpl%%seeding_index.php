...
<div class="container-fluid">
 ...
 $cid++; ?>
					<tr>
						...
						<td>
							<a class="btn" href="index.php?vedio-master-seeding-editseeding&catid=<?php echo $val['vid']; ?>" title="修改"><em class="icon-edit"></em></a>
								<a class="btn ajax" href="index.php?vedio-master-seeding-deletseeding&catid=<?php echo $val['vid']; ?>" title="删除"><em class="icon-remove"></em></a>
						</td>
					</tr>
					<?php } ?>
