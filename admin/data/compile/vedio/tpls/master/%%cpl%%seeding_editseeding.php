...
<?php } ?>
	      ...
	      <form action="index.php?vedio-master-seeding-editseeding" method="post" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="vname" name="args[vname]" type="text" value="<?php echo $this->tpl_var['cat']['vname']; ?>" needle="needle" msg="您必须输入视频名称" />
					</div>
				</div>
				<div class="control-group">
					<label for="vprice" class="control-label">直播课程价格</label>
					<div class="controls">
						<input id="vprice" name="args[vprice]" type="text" value="<?php echo $this->tpl_var['cat']['vprice']; ?>" needle="needle" msg="您必须输入视频名称" />
					</div>
				</div>
    ...
    var upload = new PolyvUpload(obj);
				...
				<div class="control-group">
					...
					<div class="controls">
		        		...
		        		<option value="<?php echo $this->tpl_var['cat']['courseify1']; ?>"><?php echo $this->tpl_var['cat']['courseify1']; ?></option>
				  		<?php $sid = 0;
 ...
 $sid++; ?>
				...
				<div class="control-group">
					...
					<div class="controls">
		        		...
		        		<option value="<?php echo $this->tpl_var['cat']['courseify2']; ?>"><?php echo $this->tpl_var['cat']['courseify2']; ?></option>
				  		<?php $sid = 0;
 foreach($this->tpl_var['courseify'] as $key => $ify){ 
 $sid++; ?>
							<?php if($ify['catpid'] == 2){ ?>
...
<embed width="320" height="240" src="<?php echo $this->tpl_var['cat']['vurl']; ?>" id="VEDIO_IMG" />
					</div>
					<div id="HTML">
				...
				<div class="control-group">
					...
					<div class="controls">
		        		...
		        		<option value="<?php echo $this->tpl_var['cat']['courseify3']; ?>"><?php echo $this->tpl_var['cat']['courseify3']; ?></option>
				  		<?php $sid = 0;
 foreach($this->tpl_var['courseify'] as $key => $ify){ 
 $sid++; ?>
				  		<?php if($ify['catpid'] == 3){ ?>
				...
				<div class="control-group">
					<label class="control-label">直播课程内容</label>
				  	<div class="controls">
					  	<textarea class="ckeditor" name="args[vcontent]" id="vcontent"><?php echo $this->tpl_var['cat']['vcontent']; ?></textarea>
					...
					<label class="control-label">需购买后查看的内容</label>
				  	<div class="controls">
					  	<textarea class="ckeditor" name="args[vpaidcontent]" id="vpaidcontent"><?php echo $this->tpl_var['cat']['vpaidcontent']; ?></textarea>
					  	<span class="help-block">加超链接的时候请首先点击源码，然后往给的标签中添加内容</span>
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
						...
						<input type="hidden" name="args[vurl]" id="remoteurl" value="<?php echo $this->tpl_var['cat']['vurl']; ?>">
						<input type="hidden" name="args[videoid]" id="videovid" value="<?php echo $this->tpl_var['cat']['videoid']; ?>">
						<input type="hidden" name="catid" id="catid" value="<?php echo $this->tpl_var['cat']['vid']; ?>">
						<input type="hidden" name="args[mp4url]" id="mp4" value="">
						<input type="hidden" name="insertquestype" value="1"/>
						<input type="hidden" name="args[videohumb]" value="<?php echo $this->tpl_var['cat']['videohumb']; ?>" id="imaes">
