...
<?php } ?>
			<ul class="breadcrumb">
				...
				<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-module-fields&moduleid=<?php echo $this->tpl_var['module']['moduleid']; ?>">字段管理</a> <span class="divider">/</span></li>
			...
			<ul class="nav nav-tabs">
				...
				<li class="pull-right">
					<a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-module-fields&moduleid=<?php echo $this->tpl_var['module']['moduleid']; ?>">字段列表</a>
				</li>
			</ul>
			<form action="?<?php echo $this->tpl_var['_app']; ?>-master-module-addfield" method="post" class="form-horizontal">
				<fieldset>
