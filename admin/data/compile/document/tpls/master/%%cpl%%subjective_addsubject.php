				...
				<div class="span6">
					...
					<thead>
						...
						<tr>
							<td width="13%">题目</td>
							<td>
								<?php echo html_entity_decode($this->ev->stripSlashes($this->tpl_var['question']['subname'])); ?>
							</td>
						</tr>
							<tr>
							<td>题型</td>
							<td><?php echo $this->tpl_var['question']['questype']; ?></td>
						</tr>
						<tr>
							<td>答题用户</td>
							<td><?php echo $this->tpl_var['question']['username']; ?></td>
						</tr>
						<?php if($this->tpl_var['question']['answer_type']==1){ ?>
							<tr>
							<td>文字答案</td>
						...
						<?php } else { ?>
							...
							<img data-src="holder.js/300x200" alt="" src="<?php echo $this->tpl_var['question']['answer_img']; ?>"></a>
							</td>
						</tr>
						<?php } ?>
					</table>	
