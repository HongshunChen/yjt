...
(function(z, m) {
	...
	function ua(a, b, c, d) {
		...
		if (d === m) var h = location.pathname.match(/^(\/.*)\//),
			d = h ? h[1] : "";
		var f;
		if (f = /^(\w+:\/\/[^\/]*)/.exec(a)) {
			if (f[1] !== c) return a
	...
	function za(a, b) {
		...
		function g(a, b, c) {
			...
			if (c.getElementsByClassName) {
				...
				for (f = e.length; h < f; h++)
					if (i = e[h], i.nodeType == 1)(b = i.className) && (" " + b + " ").indexOf(a) > -1 && g.push(i)
			}
			return g
		}
		...
		var t = !1,
			m, E, n, o, q, w, wa, H, r, s;
		w = 0;
		for (lenth = j.length; w < lenth; w++)
			if (m = j[w], m === ">") t = !0;
			else {
				if (w > 0) {
					E = [];
	...
	function Na(a, b, c) {
		...
		function g(e,
			...
			for (var n = e.firstChild, o; n;) {
				...
				if (l > 0)
					if (n.nodeType == 1)
						if (p >= 0 && t <= 0) b && k.appendChild(n.cloneNode(!0)), c && f.push(n);
						else {
							var E;
	...
	function rb(a, b) {
		...
		for (var p = 0, t = g.length; p < t; p++) {
			var k = g[p],
				j = l.compareEndPoints("StartToStart", d);
			if (j === 0) return {
				node: k.parentNode,
				offset: p
			};
		...
		if (j > 0 && h.nodeType ==
			3)
			for (c = h.previousSibling; c && c.nodeType == 3;) i -= c.nodeValue.length, c = c.previousSibling;
		return {
			node: h,
			offset: i
		}
	...
	function $a(a) {
		for (var b = document.getElementsByTagName("head")[0] || (N ? document.body : document.documentElement), c = document.createElement("link"), d = Eb(ua(a, "absolute")), e =
				f('link[rel="stylesheet"]', b), g = 0, h = e.length; g < h; g++)
			if (Eb(ua(e[g].href, "absolute")) === d) return;
		b.appendChild(c);
		c.href = a;
		c.rel = "stylesheet"
	}
			...
			if (a.useContextmenu) {
				if (a._contextmenus.length !== 0) {
					...
					for (k(a._contextmenus, function() {
							...
							else if (this.cond && this.cond() && (d.push(this),
	...
	function $b() {
		...
		if (!(o && d !== "br") && (!ca || !(B < 3 && d !== "p")) && !(Ma && B < 9)) {
			...
			f(c).keyup(function(e) {
				if (!(e.which != 13 || e.shiftKey || e.ctrlKey || e.altKey) && d != "br" && !ca)
					if (b.cmd.selection(), e = a(b.cmd.range), !(e == "marquee" || e == "select"))
						if (g[e] || O(c, "formatblock", "<p>"), e = b.cmd.commonAncestor("div")) {
	...
	if (!z.KindEditor) {
		...
		var Da = "4.1.2 (2012-07-21)",
			q = navigator.userAgent.toLowerCase(),
			o = q.indexOf("msie") > -1 && q.indexOf("opera") == -1,
			ca = q.indexOf("gecko") > -1 && q.indexOf("khtml") == -1,
			ba = q.indexOf("applewebkit") > -1,
			Ma = q.indexOf("opera") > -1,
			cc = q.indexOf("mobile") > -1,
			dc = /ipad|iphone|ipod/.test(q),
		...
		f.basePath = function() {
			for (var a = document.getElementsByTagName("script"), b, c = 0, d = a.length; c < d; c++)
		...
		f.ready = function(a) {
			...
			var e = !1;
			if (document.addEventListener) Y(document, "DOMContentLoaded", b);
		...
		F(C, {
			...
			pos: function() {
				var a = this[0],
					...
					c = 0;
				if (a)
					if (a.getBoundingClientRect) a = a.getBoundingClientRect(), c = Z(this.doc), b = a.left + c.x, c = a.top + c.y;
					else
		...
		F(K, {
			...
			commonAncestor: function() {
				...
				for (var b = a(this.startContainer),
						c = a(this.endContainer), d = 0, e = b.length, g = c.length, f, i; ++d;)
					if (f = b[e - d], i = c[g - d], !f || !i || f !== i) break;
				return b[e - d + 1]
			},
			...
			enlarge: function(a) {
				function b(b, e, g) {
					b = f(b);
					if (!(b.type == 3 || Ea[b.name] || !a && b.isBlock()))
						if (e === 0) {
							for (; !b.prev();) {
								e = b.parent();
		...
		F(ka, {
			...
			select: function(a) {
				...
				if (o) try {
					i = c.get(!0), i.select()
				} catch (p) {} else j && c.collapse(!1), i = c.get(!0), b.removeAllRanges(), b.addRange(i);
				h.focus();
				return this
			},
			wrap: function(a) {
				...
				f(a).scan(function(a) {
					if (!g &&
						...
						if (!d && b.type == 3 && A(a.nodeValue).length > 0) {
							for (var l;
								(l = b.parent()) && l.isStyle() && l.children().length == 1;) b = l;
							l = c;
							l = l.clone(!0);
							if (b.type == 3) Sa(l).append(b.clone(!1)), b.replaceWith(l);
							else {
								for (var a = b, p;
									(p = b.first()) && p.children().length == 1;) b = p;
								p = b.first();
			...
			val: function(a) {
				...
				if (a === "forecolor") return (a = this.commonNode({
					"*": ".color"
				})) && (c = a.css("color")), c = sa(c), c === "" && (c = "default"), c.toLowerCase();
				if (a === "hilitecolor") return (a =
					this.commonNode({
						"*": ".background-color"
					})) && (c = a.css("background-color")), c = sa(c), c === "" && (c = "default"), c.toLowerCase();
				return c
			},
			toggle: function(a, b) {
		...
		F(oa, Q, {
			init: function(a) {
				...
				for (var e = 0; e < b.length; e++)
					for (var c = a.insertRow(e + 1), f = 0; f < b[e].length; f++) d = c.insertCell(f), this._addAttr(d, b[e][f],
						"ke-colorpicker-cell")
			},
		...
		qa.prototype = {
			...
			exec: function(a) {
				var a = a.toLowerCase(),
					b = this.cmd,
					c = M(a, "selectall,copy,paste,print".split(",")) <
					0;
