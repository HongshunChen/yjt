var shoucangduo = {
	data: {},
	dataInit: function() {
		shoucangduo.fn.initialize();
		//		shoucangduo.fn.list_init();
	},
	eventBind: function() {},
	fn: {
		list_init: function() {},
		...
		initialize: function() {
			shoucangduo.fn.tagFill();
		},
		cordavaDataGet: function() {
			shoucangduo.dataInit();
			shoucangduo.eventBind();
