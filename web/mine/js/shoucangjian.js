var shoucangjian = {
	data: {},
	dataInit: function() {
		shoucangjian.fn.initialize();
		//		shoucangjian.fn.list_init();
	},
	eventBind: function() {},
	fn: {
		list_init: function() {},
		...
		initialize: function() {
			shoucangjian.fn.tagFill();
		},
		cordavaDataGet: function() {
			shoucangjian.dataInit();
			shoucangjian.eventBind();
...
$(function($) {
	shoucangjian.fn.cordavaDataGet();
});