var shoucangpan = {
	data: {},
	dataInit: function() {
		shoucangpan.fn.initialize();
		//		shoucangpan.fn.list_init();
	},
	eventBind: function() {},
	fn: {
		list_init: function() {},
		...
		initialize: function() {
			shoucangpan.fn.tagFill();
		},
		cordavaDataGet: function() {
			shoucangpan.dataInit();
			shoucangpan.eventBind();
