var shoucangbianxi = {
	data: {},
	dataInit: function() {
		shoucangbianxi.fn.initialize();
		//		shoucangbianxi.fn.list_init();
	},
	eventBind: function() {},
	fn: {
		list_init: function() {},
		...
		initialize: function() {
			shoucangbianxi.fn.tagFill();
		},
		cordavaDataGet: function() {
			shoucangbianxi.dataInit();
			shoucangbianxi.eventBind();
			...
			if (!config.validation.mobile(number)) {
				...
				$.ajax({
					...
					success: function(list) {
						...
						if (list.status == 1) {
							//登录成功操作
							shoucangbianxi.fn.dataFill(list);
						} else {
...
$(function($) {
	shoucangbianxi.fn.cordavaDataGet();
});