	...
	fn: {
		...
		dataFill: function(list, no) {
			if (list) {
				...
				list.data.shu = no;
				var html = template('danXuan', list.data);
		...
		//下一题
		next: function(no, id) {
			danxuanti.fn.submit_answer(no, id, 1);
		},
		//上一题
		one_more: function(no) {
			danxuanti.fn.submit_answer(no, id, 2);
		},
