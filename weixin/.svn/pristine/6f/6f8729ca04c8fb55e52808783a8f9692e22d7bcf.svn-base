...
var ctnqNativePlugin = {
     ...
     * @returns {*}
     */
nativeFunction: function(parameter, success, fail) {
    return Cordova.exec(success, fail, "ctnqNativePlugin", "openNavite", parameter);
}
};

//调用IOS方法插件
var jsApiNativePlugin = {
    /**
     * 调用IOS方法
     * @param parameter 参数[数组]
     * @param success 成功回调
     ...
     * @returns {*}
     */
jsApiNativeFunction: function(parameter, success, fail) {
    return Cordova.exec(success, fail, "jsApiNativePlugin", "apiNative", parameter);
}
};
